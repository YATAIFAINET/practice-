...
public class use_page extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wb=(WebView)findViewById(R.id.wbwbwb);
        load_config();
        get_rule_thread();
    ...
    public final void get_rule_res(String input)
    {
        ...
        String htmldata="";//http://"+ip+"/"+folder+"/join.php"
        htmldata+="<body>";
        htmldata+="<style type=text/css>\n" +
                ...
                "margin-right:3%; "+
                "\n" +
                "background-image : url(http://"+ip+"/ct/mbst/app_img/login.jpg);\n" +
                "\n" +
                //"background-position : 50% 50%; /*放在 x 軸 90% y 軸 90% */"+
        ...
        htmldata+="<div class='aaa' >【會員使用權益】</div>";//网页代码
        htmldata+="<br/>";//网页代码
        htmldata+="<div '>1. 請定時更改密碼，以確保個資安全\n</div>";//网页代码
        htmldata+="<div  '>2. 完成線上推薦，需將實際入會申請書寄回總公司。\n</div>";//网页代码
        htmldata+="<div  '>3. 獎金及業績資訊僅提供參考，最終之實際數值以公司獎金計算公佈後為準。\n</div>";//网页代码
        htmldata+="<br/>";//网页代码
        htmldata+="<div class='aaa' >【喬易國際會員條款】</div>";//网页代码
        htmldata+=input;//网页代码
        htmldata+="</body>";

        Log.d("test1216",htmldata);

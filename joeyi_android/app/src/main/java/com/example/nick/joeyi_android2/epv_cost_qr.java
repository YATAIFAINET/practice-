...
public class epv_cost_qr extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_epv_cost_qr);
        //设置屏幕方向为竖屏
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_epv_cost_qr, menu);
        return true;
    }
    ...
    private String get_qr_data_q(String query)
    {
        ...
        try
        {
            ...
            nameValuePairs.add(new BasicNameValuePair("cmd","get_epv_qrcode"));

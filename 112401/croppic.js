	...
	Croppic.prototype = {
		...
		createCropControls: function(){
			...
			if(that.options.doubleZoomControls){
				...
				that.cropControlZoomMuchIn.on('click',function(){ that.zoom( that.options.zoomFactor*size ); });
			
				that.cropControlZoomMuchOut = that.cropControlsCrop.find('.cropControlZoomMuchOut');
				that.cropControlZoomMuchOut.on('click',function(){ that.zoom(-that.options.zoomFactor*size); });
			}
